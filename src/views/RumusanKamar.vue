  ...
  <NavBar />
    <div class="bg-[#F5F7FA]">
      <!-- <v-container> -->
        ...
        <!-- Title Section -->
        <h1 class="text-2xl md:text-3xl font-bold mb-4">Rumusan Kamar</h1>
        <hr class="border-b-2 border-gray-800 mb-4">
        <p class="mb-8 text-sm md:text-base">
          Rumusan Kamar adalah keputusan atau pedoman yang dihasilkan oleh masing-masing kamar di Mahkamah Agung (seperti kamar pidana, perdata, agama, tata usaha negara dan militer) yang memberikan arahan spesifik terkait penanganan perkara di bidang hukum tertentu untuk memastikan konsistensi dalam penerapan hukum.
        </p>
