<template>
    <div class="bg-[#F5F7FA]">
      ...
      <v-container>
        ...
        <!-- Title Section -->
        <h1 class="text-2xl font-bold mb-4">Kompilasi Kaidah Hukum</h1>
        ...
        <div v-if="!state.isLoading && !state.error">
          <div class="flex flex-row items-baseline justify-between mb-0">
            <div class="mb-0">
  ...
  export default {
    ...
    data() {
      return {
        ...
        directories: ["Semua", "Putusan", "Kompilasi Kaidah Hukuman","Restatement", "Rumusan Kamar", "Rumusan Rakernas", "Yurisprudensi", "Peraturan"],
