<template>
  <div class="bg-[#F5F7FA]">
    ...
    <!-- <v-container> -->
      ...
      <v-breadcrumbs :items="items" item-class="breadcrumb-item" class="breadcrumbs text-[#8e4202] px-0">
      ...
      <!-- Title Section -->
      <h1 class="text-2xl md:text-3xl font-bold mb-4">Kompilasi Kaidah Hukum</h1>
      <hr class="border-b-2 border-gray-800 mb-4">
      <p class="mb-8 text-sm md:text-base">
        Kompilasi Kaidah Hukum adalah pengumpulan dan penyeragaman aturan-aturan hukum yang berlaku berdasarkan putusan-putusan pengadilan. Tujuannya adalah untuk memberikan pedoman bagi hakim, meningkatkan konsistensi putusan, memudahkan pemahaman masyarakat, dan mendukung evaluasi serta perbaikan hukum yang ada.
      </p>
                  ...
                  <div>
                    <div class="flex items-center mb-2 justify-between">
                      <div class="flex items-center">
                        ...
                        <span class="md:ml-0 sm:ml-0 text-green-600 sm:w-[18px] md:w-[254px] font-bold">Berkekuatan Hukum Tetap</span>
                      </div>
